...
// Exact column order matching g4.csv
var CSV_COLUMNS = [
  'success', 'test', 'trial_type', 'trial_index', 'time_elapsed',
  'internal_node_id', 'view_history', 'rt', 'response', 'stimulus',
  'phase', 'correct', 'condition', 'correct_color', 'displayed_word',
  'chosen_color', 'correct_response', 'center_direction', 'letter',
  'is_target', 'trial_index_in_block', 'signal_type', 'set_size',
  'target_present', 'task', 'number', 'is_switch'
];
...
jsPsych.init({
  ...
  on_finish: function () {
    ...
    // Build rows using exact CSV_COLUMNS order matching g4.csv
    var rows = allData.values().map(function (trial) {
      var row = {};
